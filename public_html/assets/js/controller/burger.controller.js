...
function generateBurger(){
    ...
    if(random>0 && random<=0.2){      
        $('#receta-actual').replaceWith('<img id="receta-actual" src="assets/images/receta1.png"/>');
        
    }else if(random>0.2 && random<=0.5){
       $('#receta-actual').replaceWith('<img  id="receta-actual"  src="assets/images/receta2.png"/>');
       Object.defineProperty(burger,'tomate',{value:false});
       Object.defineProperty(burger,'pepinillo',{value:false});
       delete burger.carne;
    }else{
        $('#receta-actual').replaceWith('<img  id="receta-actual"  src="assets/images/receta3.png"/>');
